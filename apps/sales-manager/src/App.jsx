          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="ml-2 text-xs text-gray-400 bg-white/10 px-2 py-0.5 rounded-full">Sales Manager</span>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-gray-300">Philippe Cartier</span>
            </div>
          </div>
        </div>
      </nav>
